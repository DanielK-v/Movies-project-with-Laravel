                ...
                <div class="card-body">
                    <form method="POST" action="/movie/{{$movie->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$movie->title}}" required autofocus>
                        ...
                        <div class="form-group row">
                            <div class="input-group date">
                                <label for="year" class="col-md-4 col-form-label text-md-right">{{ __('year') }}</label>
                                    <div class="col-md-6">
                                      <input class="date-own form-control" type="text" name="year" value="{{$movie->year}}">
                                    </div>
                            </div>
                        </div>
